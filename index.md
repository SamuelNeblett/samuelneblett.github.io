Hello! My name is Sam Neblett and this is the ePortfolio I developed for CS-499 at SNHU as part of my Capstone project.
...
## References
- de Vries, J. (n.d.). Collision detection. Retrieved from Learn OpenGL: https://learnopengl.com/In-Practice/2D-Game/Collisions/Collision-detection
- Jaworski, M. (n.d.). imgui 2.0.0. Retrieved from PyPI - The Python Package Index: https://pypi.org/project/imgui/
- LinkedIn. (n.d.). What are the most common mistakes to avoid when building a tech portfolio online? Retrieved from LinkedIn: https://www.linkedin.com/advice/1/what-most-common-mistakes-avoid-when-building
- Phrogz. (n.d.). How to get a reflection vector? Retrieved from Stack Exchange Mathmatics: https://math.stackexchange.com/questions/13261/how-to-get-a-reflection-vector
- Python. (n.d.). sqlite3 — DB-API 2.0 interface for SQLite databases. Retrieved from Python: https://docs.python.org/3/library/sqlite3.html
- SNHU. (n.d.). CS 499 Final Project Guidelines and Rubric. Retrieved from SNHU: https://learn.snhu.edu/d2l/le/content/2316141/viewContent/50704578/View
- Thomet, P. (n.d.). imgui-bundle 1.92.801. Retrieved from PyPI - The Python Package Index: https://pypi.org/project/imgui-bundle/
- W3 Schools. (n.d.). SQL Parameters. Retrieved from W3 Schools: https://www.w3schools.com/sql/sql_parameterized_queries.asp
